const modules = {
  screen: {
    ...
    title: "家庭与基层的一键早筛",
    copy:
      "通过短视频动作捕捉、眼动追踪与基础问卷，系统已支持家庭、幼儿园和基层机构完成初筛；自动生成低、中、高风险分级，并给出转诊与随访建议。",
  ...
  fusion: {
    ...
    items: ["多模态同步误差≤10ms", "多模态融合一致性≥0.85", "体脑发育增龄图谱持续迭代"],
  },
  course: {
    index: "03 / 04",
    title: "评估结果直达康教课程处方",
    copy:
      "在ABA干预基础上嵌入FMAPC精细运动课程和PMCPC体能里程碑课程，系统直接生成可执行、可追踪、可量效评估的训练方案。",
  ...
  trace: {
    ...
    title: "把每一次训练转化为长期证据",
    copy:
      "平台记录筛查、诊断辅助、干预执行和随访变化，为机构运营、产品迭代和长期服务沉淀可复用的数据资产。",
...
const roles = {
  parent: {
    label: "家庭端",
    title: "家庭端已经支持采集、报告和训练打卡",
    copy:
      "家长可在家完成短视频采集和训练任务打卡，查看风险等级、能力变化曲线和下一步就医建议，降低试错成本。",
  },
  school: {
    label: "学校/幼儿园",
    title: "学校端可按班级批量管理筛查任务",
    copy:
      "教师可按班级管理儿童筛查任务，观察动作、步态、精细操作和社交注视变化，及时与家长和基层机构协同。",
  },
  clinic: {
    label: "基层与康复机构",
    title: "机构端把评估、处方和量效反馈放在同一屏",
    copy:
      "机构可用诊断仪完成标准化评估，生成课程处方，持续追踪FMAPC和PMCPC训练效果，提升服务质量和连续康复能力。",
  },
  doctor: {
    label: "专科医生端",
    title: "医生端汇总多场景数据，辅助诊断与转诊闭环",
    copy:
